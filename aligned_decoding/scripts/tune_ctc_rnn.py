...
from realtime_sim.realtime_datamodule import (CTCHeldOutDataModule,
                                              CTCHeldOutTargetValDataModule,
                                              CTCHeldOutTargetValCVDataModule)
...
def main(cfg: DictConfig) -> None:
    ...
    if cfg.pool_train:
        ...
        # Generate chance labels by randomly selecting phonemes btw silence
        # y_train_tgt = make_chance_labels(y_train_tgt.shape[0], y_train_tgt.shape[1], n_sil=N_SIL)
